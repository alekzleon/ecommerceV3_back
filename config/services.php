...
return [
    ...
    */
    ...
    'mercadopago' => [
        ...
        'oauth_success_url' => env('MERCADOPAGO_OAUTH_SUCCESS_URL', env('FRONTEND_URL', 'http://localhost:5173').'/admin/payments'),
        'oauth_error_url' => env('MERCADOPAGO_OAUTH_ERROR_URL', env('FRONTEND_URL', 'http://localhost:5173').'/admin/payments'),
