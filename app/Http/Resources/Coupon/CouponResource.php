...
class CouponResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        return [
            ...
            'is_combinable' => (bool) $this->is_combinable,
            ...
            'trigger_coupon_id' => $this->trigger_coupon_id,
            'trigger_coupon' => $this->whenLoaded('triggerCoupon', fn () => $this->triggerCoupon ? [
                'id' => $this->triggerCoupon->id,
                'code' => $this->triggerCoupon->code,
                'name' => $this->triggerCoupon->name,
            ] : null, null),
